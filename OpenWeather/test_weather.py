...
from main import get_weather, build_query_param
...
class TestWeatherFunctions(unittest.TestCase):
    ...
    def test_build_query_param_city_and_coordinates(self):
        ...
        self.assertIn("40.7128", query)
        self.assertIn("-74.006", query)
        self.assertEqual(query.count(";"), 1)  # One separator between city and coordinates
    ...
    def test_build_query_param_multiple_cities_and_coordinates(self):
        ...
        self.assertIn("40.7128", query)
        self.assertIn("-74.006", query)
        self.assertEqual(query.count(";"), 2)  # Two separators: between cities and between cities and coordinates
    ...
    def test_build_query_param_coordinates_only(self):
        ...
        self.assertIn("-74.006", query)
        self.assertIn(",", query)
        self.assertEqual(query.count(";"), 0)  # No separators for single coordinate pair
    ...
    def test_get_weather_malformed_city_input(self, mock_get):
        """Test weather fetch with malformed city input that might cause parsing issues"""
        ...
        for malformed_input in malformed_inputs:
            with self.subTest(malformed_input=malformed_input):
                ...
                with patch('builtins.print') as mock_print:
                    ...
                    # Verify error message was printed
                    mock_print.assert_called_with("Error: An invalid (or missing) query value was specified.")
